...
\usepackage[asbox,automarks,box,catalog,lang=FR,noshuffle,noshufflegroups,separateanswersheet]{automultiplechoice}
...
\begin{examcopy}[2]
	\begin{tikzpicture}[remember picture, overlay]
		\node[anchor=south west, xshift=-2mm, yshift=0.5cm] at (0,0) {\includegraphics[height=48pt]{Logo-HEH-DST.png}};
	\end{tikzpicture}
	\setcounter{figure}{0}
